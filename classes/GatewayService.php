...
//
    if (strcmp($serverName, "gw.php-rocketgate-class.com") != 0) {
	...
	$hostList = array();			// Create an array
	$hostList[0] = "gw-16.php-rocketgate-class.com";	// Add default resolution
	$hostList[1] = "gw-17.php-rocketgate-class.com";
      } else {
	...
	while ($index < $listSize) {		// Loop over all entries
	  if (strcmp($hostList[$index], "69.20.127.91") == 0)
	    $hostList[$index] = "gw-16.php-rocketgate-class.com";
	  if (strcmp($hostList[$index], "72.32.126.131") == 0)
	    $hostList[$index] = "gw-17.php-rocketgate-class.com";
